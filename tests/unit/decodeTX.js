...
describe('Blockcypher decodeTX Method: ', function () {


  describe('Success: ', function () {

    it('When hex exist', sinon.test(function (done) {

      let hex = 'fancyHex';

      let validData = { tx: hex };
      let params = {};
      let validEndpoint = '/txs/decode';

      let validReturn = { data: { key1: 'value', key2: 2 } };
      this.stub(bcapi, '_post').yields(null, validReturn);
      bcapi.decodeTX(hex, function (e, r) {

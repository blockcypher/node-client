...
describe('Blockcypher createWallet Method: ', function(){


  describe('Success: ', function() {

    it('When addr and value exist', sinon.test(function(done) {

        let data = {name: 'name', addresses: ['arealaddress']};
        let params = {};
        ...
        bcapi.createWallet(data, function(e,r) {
  ...
  describe('Errors: ', function(){
    ...
    it.skip('When addresses is null/undefined', function(done){done();}); //TODO Error out when name does not exist

...
describe('Blockcypher getWallet Method: ', function(){


  describe('Success: ', function() {

    it('When name is a string and params exists', sinon.test(function(done) {

        let name = 'human';
        let params = {};
        let validEndpoint = '/wallets/' + name;

        let validReturn = {data: {key1:'value', key2: 2}};
        this.stub(bcapi, '_get').yields(null, validReturn);
        bcapi.getWallet(name, function(e,r) {

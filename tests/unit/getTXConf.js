...
describe('Blockcypher getTXConf Method: ', function () {


  describe('Success: ', function () {

    it('When hash is a string and params exists', sinon.test(function (done) {

      let hash = '12345';
      let params = {};
      let validEndpoint = '/txs/' + hash + '/confidence';

      let validReturn = { data: { key1: 'value', key2: 2 } };
      this.stub(bcapi, '_get').yields(null, validReturn);
      bcapi.getTXConf(hash, function (e, r) {

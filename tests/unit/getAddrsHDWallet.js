...
describe('Blockcypher getAddrsHDWallet Method: ', function () {


  describe('Success: ', function () {

    it('When name a string and params exists', sinon.test(function (done) {

      let name = 'human';
      let params = {};
      let validEndpoint = '/wallets/hd/' + name + '/addresses';

      let validReturn = { data: { key1: 'value', key2: 2 } };
      this.stub(bcapi, '_get').yields(null, validReturn);
      bcapi.getAddrsHDWallet(name, function (e, r) {

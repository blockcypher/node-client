...
describe('Blockcypher createHDWallet Method: ', function () {
  ...
  describe('Success: ', function () {
    ...
    it('When data.name and data.extended_public_key exist', test(function (done) {
      ...
      bcapi.createHDWallet(data, function (e, r) {
  ...
  describe('Errors: ', function () {
    ...
    it.skip('When extended_public_key is null/undefined', function (done) { done(); }); //TODO Error out when name does not exist

  });//end of error cases;



});//end of createHDWallet
